                            ...
                            <a href="?message=<?= $IdUnikMessage ?>"
                                ...
                                <div class="d-flex gap-3 w-100 justify-content-between">
                                    <div>
                                        ...
                                        <div class="com_coob">
                                            <p class="mb-0 opacity-75 d-inline-block text-truncate"
                                                style="width:360px;">
                                                <?= $message['Appeal'] ?>
                                            </p>
                                        </div>
...
<!--Конец сообщения-->
                ...
                ?>
                        ...
                        <form action="Nextnewmessage.php" method="post">
                                    <div style="display:flex;">
                                        <input type="text" name="input" class="shadow-sm mb-1 bg-white rounded"
                                            style="border: none; width: 90%;padding: 10px; margin-top:2px;"
                                            placeholder="Напишите сообщение...">
                                        <button type="submit" class="shadow-sm mb-1 bg-white rounded"
                                            style="border: none; width: 50px; height: 50px; margin-left: 10px;margin-top:10px;">
