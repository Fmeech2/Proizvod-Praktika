    ...
    <form action="../MySQL/ProfilEdit.php" method="post">
        <div class="start">
            ...
            <div style="width: 100%;   ">
                ...
                <h4 id="here" style="margin-top: 70px;">• Как увидеть ответ техподдержки:</h4> 
                <p style="margin-left: 20px; font-size:120%;">шаг 1: Нажмите на ваше обращение, которое вы хотите просмотреть.   </p>
                ...
                <p style="margin-left: 20px; font-size:120%;">шаг 2: Если вам уже ответила техподдержка, то вы увидите соответствующее сообщение.   </p>
                <div  class="class_img_reference">
                    <img src="8.jpg" class="img_reference_small" >
                    <div style="display:flex; justify-content: center;margin-bottom: 20px;">
                        Рисунок к шагу 2
                    </div>
                </div>

                <p style="margin-left: 20px; font-size:120%;">шаг 3: Если у вас возникли вопросы по этому обращению, вы можете отправить ещё сообщение, не открывая новое обращение.   </p>
                <div  class="class_img_reference">
                    <img src="9.jpg" class="img_reference_small" >
                    <div style="display:flex; justify-content: center;margin-bottom: 20px;">
                        Рисунок к шагу 3
                    </div>
                </div>
                
                <p style="margin-left: 20px; font-size:120%;">шаг 4: После того как вы решили свои проблемы вы должны будете закрыть обращение.   </p>
                <div  class="class_img_reference">
                    <img src="10.jpg" class="img_reference_small" >
                    <div style="display:flex; justify-content: center;margin-bottom: 20px;">
                        Рисунок к шагу 4
                    </div>
                </div>
